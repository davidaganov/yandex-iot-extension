...
> Расширение дополнительно открывает сайт в popup и снимает запрет iframe (DNR). Userscript этого не делает — он только правит открытую вкладку.
